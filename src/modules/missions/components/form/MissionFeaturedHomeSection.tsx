...
export default function MissionFeaturedHomeSection({
    form,
    onChange,
}: Props) {
    return (
        <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            <div>
                ...
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Activa esta misión para mostrarla en la página de inicio y
                    define su orden de aparición.
                </p>
            </div>
            ...
            <div className="mt-6 grid grid-cols-1 gap-5 lg:grid-cols-2">
                <div>
                    ...
                    <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                        Si está activo, esta misión podrá aparecer en la
                        landing principal.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                        Selecciona una posición del 1 al 6 para ordenar las
                        misiones destacadas en el home.
                    </p>
                </div>
            </div>
        </div>
